                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <h4>
                                    ...
                                    <h4>Edit Employee Attendance List</h4>
                            ...
                            <form action="{{ route('employee.attend.store') }}" method="post" id="myForm">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" name="date" id="date"
                                        ...
                                        value="{{ $editData[0]['date'] }}" placeholder="Attendance Date" autocomplete="off">
                                </div>
                                        ...
                                        @foreach ($editData as $key => $employee)
                                            <tr class="text-center">
                                                <input type="hidden" name="employee_id[]"
                                                    value="{{ $employee->employee_id }}" class="employee_id">
                                                <td>{{ $key + 1 }}</td>
